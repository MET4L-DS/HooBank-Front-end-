...
const Testimonials = () => (
    <section
        id="clients"
        className={`${styles.paddingY} ${styles.flexCenter} ${styles.paddingX} relative flex-col`}
    >
        <div className="-z-1 blue__gradient absolute left-0 top-[18%] h-[288px] w-[526px] rounded-full"></div>
        <div className="blue__gradient absolute -right-[50%] bottom-40 z-[0] h-[60%] w-[60%] rounded-full"></div>
